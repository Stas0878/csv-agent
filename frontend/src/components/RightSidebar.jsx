...
export default function RightSidebar({ t, agents, selectedAgentId, onSelectAgent, onToggleAgent, onRefresh, glowMode = "strong", parallax = true, onCollapse }) {
  ...
  return (
    <aside className="h-full w-56 lg:w-64 min-w-[224px] lg:min-w-[256px] max-w-[320px] bg-card/60 backdrop-blur-sm flex flex-col border-l border-border" aria-label="Right sidebar">
