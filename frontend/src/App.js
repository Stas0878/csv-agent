      ...
      <div className="flex h-full">
        ...
        <div className="flex-1 min-w-0 min-h-0 flex flex-col">
          <Topbar 
            ...
            glowMode={uiConfig.effects.glowMode} 
            setGlowMode={(m)=> setUiConfig(prev => ({ ...prev, effects: { ...prev.effects, glowMode: m } }))} 
            connStatus={connStatus} 
            onOpenPreview={openPreview} 
            canOpenPreview={!isEmbed} 
            onOpenAdmin={!isEmbed ? handleOpenAdmin : undefined} 
            customButtons={!isEmbed ? uiConfig.custom.buttons : []}
            // Navigation props
            canGoBack={canGoBack}
